...
#from bin_index.binary_index_adapters import tf_idf_adapter, boolean_adapter, direct_adapter, offset_adapter
...
class SearchEngine:
    ...
    def __adapter(self, tkn):
        ...
        if preprocessed in self.stopTerms:
            return tuple(self.wholeSet)
    ...
    def __build_vector_from_query(self, terms):
        ...
        idfs = [self.index[term][0] if self.index[term]
                else 1. for term in terms]
